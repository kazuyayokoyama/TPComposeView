...
-(void)drawRect:(CGRect)rect
{
    ...
    [_title drawInRect:CGRectMake(0.0, 5.0, rect.size.width, 30.0) withFont:[UIFont boldSystemFontOfSize:14] lineBreakMode:UILineBreakModeClip alignment:UITextAlignmentCenter];        
}
